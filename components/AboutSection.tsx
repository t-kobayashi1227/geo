...
export function AboutSection() {
  return (
    <section className="relative -mt-15 overflow-hidden bg-brand-brown pt-16 pb-16 text-white 
        mt-[-100px] rounded-[20px] pt-12 pb-24 [clip-path:polygon(0_0,20%_0,50%_2%,80%_0,100%_0,100%_100%,0_100%)] 
        sm:mt-[-140px] rounded-[20px] pt-12 pb-24 [clip-path:polygon(0_0,20%_0,50%_2%,80%_0,100%_0,100%_100%,0_100%)] 
