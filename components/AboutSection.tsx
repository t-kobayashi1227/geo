...
export function AboutSection() {
  return (
    <section className="relative -mt-15 overflow-hidden bg-brand-brown pt-10 pb-16 text-white 
        mt-[-100px] rounded-[20px] [clip-path:polygon(0_0,20%_0,50%_2%,80%_0,100%_0,100%_100%,0_100%)] 
        sm:mt-[-140px] rounded-[20px] sm:pt-12 sm:pb-24 sm:[clip-path:polygon(0_0,20%_0,50%_2%,80%_0,100%_0,100%_100%,0_100%)] 
        ...
        ">
      <div className="relative mx-auto flex max-w-[1280px] flex-col px-4 md:px-10 md:mt-10">
