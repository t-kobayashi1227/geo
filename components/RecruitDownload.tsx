...
const defaultHeading = (
  <>
    <span className="text-lg md:text-[40px]">詳しくはこちらから資料をダウンロードしてね！</span>
  </>
);

export function RecruitDownload({
  ...
  return (
    <section className="bg-background pb-16 md:pb-24">
      <div className="mx-auto max-w-[1280px] px-4 md:px-10">
        <Link
          href={href}
          className="block rounded-[24px] bg-[#065789] px-6 py-8 text-center text-white transition-opacity hover:opacity-90 md:rounded-[44px] md:px-12 md:py-14"
        >
