    ...
    <div id="top" className="flex min-h-full flex-1 flex-col bg-background">
      ...
      <main className="flex-1">
        <section className="bg-[linear-gradient(170deg,#eef7fe_0%,#dcecfb_100%)] px-4 py-12 text-center md:px-10 md:py-[46px]">
          ...
          <p className="mt-2 text-[9px] tracking-[3px] text-[#88a0b3] md:text-[11px] md:tracking-[5px]">CONTACT</p>
          <p className="mx-auto mt-5 max-w-[480px] text-sm leading-[1.9] text-[#46607a] md:max-w-none md:text-[14px]">
